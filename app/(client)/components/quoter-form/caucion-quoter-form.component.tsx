'use client';
import { caucionSchema } from "@/app/schema/form-schema";
...
export const CaucionQuoterForm = () => {

  const [state, formAction] = useFormState(onSubmitAction, {
    message: "",
  });
  const form = useForm<z.output<typeof caucionSchema>>({
