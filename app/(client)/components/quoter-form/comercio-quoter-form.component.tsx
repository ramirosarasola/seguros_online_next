'use client';
import { comercioSchema } from "@/app/schema/form-schema";
...
export const ComercioQuoterForm = () => {

  const [state, formAction] = useFormState(onSubmitAction, {
    message: "",
  });
  const form = useForm<z.output<typeof comercioSchema>>({
