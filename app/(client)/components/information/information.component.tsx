      ...
      <article className="flex flex-col items-start">
        <div className="flex flex-col items-start justify-between">
          <ul className="w-full flex items-start justify-between mb-6">
            ...
            >
              <Link href="#tab1" onClick={() => handleTabClick("tab1")}>
                Coberturas Básicas
              </Link>
            </li>
            <li
            ...
            >
              <Link href="#tab2" onClick={() => handleTabClick("tab2")}>
            ...
            >
              <Link href="#tab3" onClick={() => handleTabClick("tab3")}>
                En caso de Siniestro
              </Link>
            </li>
            <li
              className={`${
                activeTab === "tab4" ? "active_tab" : ""
              } font-bold text-gray-600 `}
            >
              <Link href="#tab4" onClick={() => handleTabClick("tab4")}>
                Seguros de Autos
              </Link>
            </li>
            <li
              className={`${
                activeTab === "tab5" ? "active_tab" : ""
              } font-bold text-gray-600 `}
            >
              <Link href="#tab5" onClick={() => handleTabClick("tab5")}>
          ...
          <div className="tabs-container">
            ...
            >
              ...
              Robo o hurto de la unidad asegurada. Se considera robo total
              pasado los 30 días desde la fecha de desaparición del vehículo
              para que la Compañía responda por la suma asegurada{"\n"}
              ...
              son los daños sufridos por el auto como consecuencia de la acción
              del fuego o explosión que hubieran dejado a la unidad con daños en
              más del 80%{"\n"}
              <strong>Incendio parcial:</strong>
              son los daños materiales sufridos por el auto como consecuencia de
              la acción del fuego o explosión que hubieran dejado a la unidad
              con daños en menos del 80%{"\n"}
              <strong>Daño Total:</strong>
              En caso que el valor de reparación sea igual o superior al 80% del
              valor del vehículo al momento del siniestro. La compañía
              indemnizará al asegurado con el 100% del valor de la suma
              asegurada{"\n"}
              <strong>Daños Parciales al amparo de robo aparecido:</strong>
              Cubre Los daños que resultaran como consecuencia del robo o hurto
              del vehículo tras la recuperación del mismo.
            </div>
            <div
              className=""
              id="tab2"
            ...
            >
              ...
              Esta cláusula cubre a autos 0km, que hubieran sido aseguradas como
              0km, hasta 12 meses de antigüedad. En caso de robo total o
              ...
              primeros años. En caso de robo total se repondrán los neumáticos a
              nuevo{"\n"}
              <strong>Rastreo Satelital</strong>
              En caso que la compañía estipule que es necesario puede colocar un
              dispositivo de rastreo satelital en el automotor asegurado{"\n"}
              ...
              Asistencia general al viajeros que se encuentren a más de 100km
            ...
            >
              ...
              / 011 5199-8100, ó por mail a: denuncias@segurosonline.com.ar
              {"\n"}
              En caso que solo hay daños materiales, no haría falta hacer la
              ...
              tenga que perder tiempo y dinero en estos trámites{"\n"}
              La compañía aseguradora asignará un gestor para reclamos y
              gestiones diversas.
            </div>
            <div
              className=""
