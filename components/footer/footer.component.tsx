...
export const Footer = () => {
  return (
    <footer className='bg-primary text-secondary flex flex-col px-16 py-8 gap-8 justify-between items-center'>
      ...
      <div className='w-full flex items-center justify-start gap-8'>
        <p className="w-[60%]">© 2023 SegurosOnline.com.ar - Desarrollado por IDE-AR y RamSar-Dev</p>
